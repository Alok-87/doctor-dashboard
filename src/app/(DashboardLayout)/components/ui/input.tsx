    ...
    >
      <Headless.Input
        ...
        className={clsx(
          ...
          // Typography
          'text-base/6 text-zinc-900 placeholder:text-zinc-500 sm:text-sm/6 dark:text-zinc-100 dark:placeholder:text-zinc-500',
          // Border + hover + focus
          'border border-zinc-950/10 data-hover:border-zinc-950/20 focus:border-blue-500',
          'dark:border-white/10 dark:data-hover:border-white/20 dark:focus:border-blue-400',
          // Backgrounds
          'bg-white dark:bg-zinc-900',
          // Transition
          'transition-colors duration-150',
          // Invalid state
          'data-invalid:border-red-500 dark:data-invalid:border-red-600',
          // Disabled
          'data-disabled:border-zinc-950/20 dark:data-disabled:border-white/15 dark:data-disabled:bg-white/5',
